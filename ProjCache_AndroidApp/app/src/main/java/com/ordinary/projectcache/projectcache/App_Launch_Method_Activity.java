...
public class App_Launch_Method_Activity extends AppCompatActivity {
    ...
    ArrayList<InstalledAppInfo> selectedAppArrList = new ArrayList<>();
        AdapterForAppList adapterForAppListView;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            app_picker_context = App_Launch_Method_Activity.this;
            ...
            pm = App_Launch_Method_Activity.this.getPackageManager();
...
//        adapterFortimeListView = new ArrayAdapter<String>(app_picker_context, R.layout.app_list_layout, R.id.condition_name, selectedAppArrList);
            adapterForAppListView = new AdapterForAppList(app_picker_context, selectedAppArrList);
            selectedAppListView.setAdapter(adapterForAppListView);
            ...
            public void onClick(View v) {
                Intent intent = new Intent(app_picker_context, Applist_Activity.class);
                        ...
                        if (!checkDuplicate(returnedApp, selectedAppArrList)) {
                            if (returnedApp != null) {
                                try {
                                    ...
                                    adapterForAppListView.notifyDataSetChanged();
                                    TF.setListViewHeightBasedOnChildren(adapterForAppListView, selectedAppListView);
